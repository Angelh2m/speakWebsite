...
PRIVATE_KEY_JSON = 'My First Project-71fdb3f9d9a6.json'
...
class OauthAccessTokenGetter:
    ...
    def SendRequest(self, body):
        ...
        body_urlencode = urlencode(body).encode('utf-8');
        print(body_urlencode);
        return urlopen(self.REQUEST_URL, body_urlencode).read()
...
if __name__ == '__main__':
    print (OauthAccessTokenGetter(PRIVATE_KEY_JSON, API_SCOPE,
                                  ACCESS_TOKEN_VALIDITY_SECS).GetSignedJwt())
